...
//    private float[] _myArrayRepresentation = new float[3];
    ...
    static public Vector3f add(Vector3f theVectorA, Vector3f theVectorB, Vector3f theTarget) {
        if (theTarget == null) {
        	theTarget = new Vector3f(theVectorA.x+theVectorB.x, theVectorA.y+theVectorB.y, theVectorA.z+theVectorB.z);
        }else{
        	theTarget.set(theVectorA.x+theVectorB.x, theVectorA.y+theVectorB.y, theVectorA.z+theVectorB.z);
        }
        return theTarget;
	}	
    ...
    static public Vector3f sub(Vector3f theVectorA, Vector3f theVectorB, Vector3f theTarget) {
        if (theTarget == null) {
        	theTarget = new Vector3f(theVectorA.x-theVectorB.x, theVectorA.y-theVectorB.y, theVectorA.z-theVectorB.z);
        }else{
        	theTarget.set(theVectorA.x-theVectorB.x, theVectorA.y-theVectorB.y, theVectorA.z-theVectorB.z);
    ...
    public Vector3f clone() {
    	Vector3f clone = new Vector3f(x, y, z);
    	return clone;
    }
